...
class ControllerAccountOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['date_added'] = date($this->language->get('date_format_stylewe'), strtotime($order_info['date_added']));
            ...
            $data['shipping_address'] = sprintf("<h4>%s %s</h4><p>%s, %s, %s%s, %s<br>Phone:2023282516 </p>",
                $order_info['shipping_firstname'], $order_info['shipping_lastname'],
                $order_info['shipping_address_1'], $order_info['shipping_city'], $order_info['shipping_zone'] ? $order_info['shipping_zone'].', ' : "", $order_info['shipping_postcode'], $order_info['shipping_country']
                );
			...
			foreach ($totals as $total) {
				$data['totals'][$total['code']] = $this->currency->format($total['value'], $order_info['currency_code'], $order_info['currency_value']);
			}
