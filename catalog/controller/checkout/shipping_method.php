...
class ControllerCheckoutShippingMethod extends Controller {
	public function index() {
        ...
        // initial session 'shipping_method'
        if (!isset($this->session->data['shipping_method']) && isset($quote_code)) {
            $this->session->data['shipping_method'] = $this->session->data['shipping_methods'][$quote_code]['quote'][$quote_code];
        }
